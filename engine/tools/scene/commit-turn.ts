...
export const commitTurnToolDefinition: DomainToolDefinition = {
  ...
  parameters: Type.Object({
    ...
    events: Type.Array(
      Type.Object({
        kind: Type.String({
          description: "scene / actor-condition / outfit / economy / memory / hint-secret / hook",
        }),
        event: Type.Unknown({
          description:
